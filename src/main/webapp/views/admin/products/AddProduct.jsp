						...
						<div class="card-header">
							...
							<c:if test="${not empty error }">
								<div class="alert alert-danger alert-dismissible" role="alert">
									...
									<div class="alert-message">
										<strong>Thêm thất bại!</strong> ${error }
									</div>
								</div>
							</c:if>
							...
							<c:if test="${not empty message }">
								<div class="alert alert-success alert-dismissible" role="alert">
									...
									<div class="alert-message">
										<strong>Thêm thành công!</strong> ${message }
									</div>
								</div>
							</c:if>
						...
						<div class="card-body">
							...
							<form action="admin-sanpham-add" method="POST"
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<select class="form-control mb-3" name="brand">
											...
											<c:forEach var="brand" items="${addProduct.allBrands }">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="file" name="file" multiple="multiple"> <small
